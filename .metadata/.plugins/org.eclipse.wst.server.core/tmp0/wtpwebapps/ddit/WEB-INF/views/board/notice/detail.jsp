		...
		<div class="row justify-content-between align-items-center mb-10">
			...
			<div class="col-12 col-lg-auto mb-20">
				<div class="page-heading">
					<h3 class="title" style="text-align: left;">공지사항</h3>
				</div>
			</div>
			<!-- Page Heading End -->
		</div>
			...
			<div class="col-12">
				<div class="box">
					<div class="box-head" style="display: inline-block; margin: 0 auto;">
						...
						<a>작성자 : </a> <a>${post.post_writer}</a> &nbsp;&nbsp; <a>|</a> <a> 작성일자 : </a> <a>${post.post_reg_date}</a> &nbsp;&nbsp; <a>|</a> <a> 수정일자 : </a> <a>${post.post_update_date}</a> &nbsp;&nbsp; <a>|</a> <a> 조회수 : </a> <a>${post.post_viewcnt }</a>
					</div>
