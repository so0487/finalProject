	...
	<div class="add-edit-product-wrap col-12" style="background-color: white; margin-top:-50px ">
		...
		<div class="row justify-content-between align-items-center mb-10">
			...
			<div class="col-12 col-lg-auto mb-20">
				<div class="page-heading">
					<h3 class="title" style="text-align: left;">공지사항 수정</h3>
				</div>
			</div>
			<!-- Page Heading End -->
			<!-- button -->
		...
		<form role="form" method="post" action="modify.do" name="modifyForm">
			<div class="row">
				...
				<input type="hidden" name="board_no" value="BOARD001" />
			...
			<div class="row">
				<div class="col-12 mb-30">
					<div class="box">
						...
						<div class="box-body">
							<textarea id="post_content" name="post_content" class="summernote" maxlength="2000">${post.post_content }</textarea>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	$('#cancelBtn').on('click', function(e) {
		location.href='<%=request.getContextPath() %>/board/notice/detail.page?post_no=${post.post_no}';
	});
</script>
