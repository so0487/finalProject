		...
		<div class="row justify-content-between align-items-center mb-10">
			...
			<div style="z-index: 1; position: absolute; top: 142px; right: 80px;">
				<button class="btn btn-outline" style="border:1px solid #dddddd;"
					onclick="location.href='<%=request.getContextPath()%>/board/pds/registForm'">
					<span>등록</span>
				</button>
			</div>
		</div>
								...
								<c:forEach items="${postList}" var="post">
									<tbody>
										<tr>
											...
											<td style="width:50%"><a href="javascript:location.href='<%=request.getContextPath() %>/board/pds/detail.page?post_no=${post.post_no}'">${post.post_title}</a></td>
