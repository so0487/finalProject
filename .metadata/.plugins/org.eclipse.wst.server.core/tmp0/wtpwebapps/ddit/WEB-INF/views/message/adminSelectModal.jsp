						...
						<div class="form-group">
							<table class="table footable">
								...
								<c:forEach items="${adminList}" var="adminList"	varStatus="status">
									<c:if test="${adminList.member_role eq 'ADMIN'}">
										<tbody>
											<tr>
												<th><input type="checkbox" name="member" id="member" class="member" value="${adminList.member_id}"></th>
												<td>${adminList.member_id}</td>
												<td>${adminList.member_name}</td>
												<td>${adminList.member_role}</td>
											</tr>
										</tbody>
									</c:if>
								</c:forEach>
							...
							<div class="card-footer">
								<%@include file="/WEB-INF/views/pagination/messageAdmin_pagination.jsp" %>
							</div>
						</div>
					</div>
				</div>
