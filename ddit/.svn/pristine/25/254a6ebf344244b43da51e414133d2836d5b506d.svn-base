...
<div class="content-body">
	...
	<form action="adminModify.do" method="post" name="modifyForm" id="modifyForm2" enctype="multipart/form-data">
		...
		<div class="input-group col-lg-5">		
			...
			<div>
				...
				<input id="inputFileName" class="form-control" style="width:200px;height:40px;margin-left:70px;" type="text" name="tempPicture" disabled/>
	...
	<span style="width:70px; display:inline-block; text-align: right;">주소 : </span>
			<input type="text" id="member_zip" name="member_address" placeholder="우편번호" class="form-control" value="${fn:split(member.member_address,',')[0] }"
				style="width:187px; margin-bottom: 5px;display:inline-block;" readonly><input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기" class="btn btn-info">
	...
	<br><br>
	<button id="modifyBtn" style="border:1px solid #dddddd" class="buttonn button-outline" type="button">수정</button>
	<button type="button" style="border:1px solid #dddddd" class="buttonn button-outline" id="cancelBtn">취소</button>
	</form>
