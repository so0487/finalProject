...
<div class="footer-section"  style="position:relative; width:100%;">
	<div class="container-fluid">
		<div class="footer-copyright text-center"
			style="width: 80%; position: absolute; bottom: 0px; text-align: center;">
			<p class="text-body-light">Copyright© 2020 by ddit</p>
		</div>
	</div>
	...
	<!-- 테이블 js -->
    <script src="<%=request.getContextPath()%>/resources/bootstrap/adomx-html-tf-v1.1/html/light/assets/js/plugins/moment/moment.min.js"></script>
    <script src="<%=request.getContextPath()%>/resources/bootstrap/adomx-html-tf-v1.1/html/light/assets/js/plugins/footable/footable.min.js"></script>
    <script src="<%=request.getContextPath()%>/resources/bootstrap/adomx-html-tf-v1.1/html/light/assets/js/plugins/footable/footable.active.js"></script>
	
	
	<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/morris.js/0.5.1/morris.css">
	<%@ include file="footer_js.jsp" %>
	<%@ include file="summernote_js.jsp" %>
	<script src="<%=request.getContextPath()%>/resources/bootstrap/adomx-html-tf-v1.1/html/light/assets/js/plugins/sweetalert/sweetalert.min.js"></script>
<%-- 	<script src="<%=request.getContextPath()%>/resources/bootstrap/adomx-html-tf-v1.1/html/light/assets/js/plugins/sweetalert/sweetalert.active.js"></script> --%>
