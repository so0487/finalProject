		...
		<div class="col-12">
			<div class="box">
				...
				<div style="z-index: 1; position: absolute; bottom: 20px; right: 40px; margin-top: 20px;">
					...
					<button style="border:1px solid #dddddd" class="btn btn-outline" id="modifyBtn" style="margin-left: 4px;">
						<span>수정</span>
					</button>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button style="border:1px solid #dddddd" class="btn btn-outline" id="replyModBtn">수정</button>
					<button style="border:1px solid #dddddd" class="btn btn-outline" id="replyDelBtn">삭제</button>
