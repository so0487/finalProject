	                               ...
	                               <tbody>
								   		<c:forEach items="${cslList }" var="csl" varStatus="status">
								   			<tr>
								   				...
								   				<td><fmt:formatNumber value="${csl.assign * evaToLecList[2].eva_to_lec_ratio/100}" pattern="#,##"/></td>
								   				<td><fmt:formatNumber value="${csl.ratio * evaToLecList[0].eva_to_lec_ratio/100 + csl.test * evaToLecList[1].eva_to_lec_ratio/100 +csl.assign * evaToLecList[2].eva_to_lec_ratio/100}" pattern="#,##"/></td>
								   				
								   				<c:if test="${csl.ratio * evaToLecList[0].eva_to_lec_ratio/100 + csl.test * evaToLecList[1].eva_to_lec_ratio/100 + csl.assign * evaToLecList[2].eva_to_lec_ratio/100>= 80}">
