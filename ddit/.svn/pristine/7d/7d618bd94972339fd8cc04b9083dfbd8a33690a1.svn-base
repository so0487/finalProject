...
//					.append("<a href='http://192.168.31.14/ddit/'").append("target='_blenk'>DDIT 홈페이지 열기</a>").toString());
	...
	@Override
	public List<MemberVO> getMemberByRole(String member_role) throws SQLException {
		
		return memberDAO.selectMemberByRole(member_role);
	}

	@Override
	public List<MemberVO> getProAdminByTime(Map<String, String> param) throws SQLException {
		return memberDAO.selectProAdminByTime(param);
	}
