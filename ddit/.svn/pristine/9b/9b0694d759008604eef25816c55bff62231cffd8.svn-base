...
import kr.or.ddit.request.ModifyPostRequest;
...
public class ImpBoardController {
	...
	@RequestMapping(value = "modify", method = RequestMethod.POST, produces = "text/plain;char=utf-8")
	public void modify(ModifyPostRequest modifyReq, HttpServletResponse response) throws Exception {
		String fileUploadPath = this.pdsfileUploadPath;
