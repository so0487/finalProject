                            ...
                            <table class="table">
                                  <thead>
                                      <tr>
                                          ...
                                          <th data-name="class_number">훈련시작날짜</th>
                                          <th data-name="class_number">훈련종료날짜</th>
                                          <th data-name="class_number">훈련생수</th>
                              ...
                              <c:forEach items="${classList }" var="classVO"  varStatus="status">
                                         <tr>
                                             ...
                                             <td>${classVO.class_start_date }</td>
                                             <td>${classVO.class_end_date }</td>
