...
<form id="jobForm">
	<input type='hidden' name="keyword" value="${curriculum.curriculum_no  }">
	<input type='hidden' name="searchType" value="curriculum_no" />
...
function searchList_go(page,url){	
	...
	var jobForm=$('#jobForm');
// 	jobForm.find("[name='keyword']").val(${curriculum_no});
	jobForm.find("[name='page']").val(page);
// 	jobForm.find("[name='perPageNum']").val();
// 	jobForm.find("[name='searchType']").val("curriculum_no");
