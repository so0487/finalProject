...
public class BoardReplyController {
	...
	@RequestMapping(value = "/board/{board_no}/{post_no}/{page}", method = RequestMethod.GET)
	...
	@RequestMapping(value="board/{board_no}/{reply_no}", method= {RequestMethod.PUT, RequestMethod.PATCH})
	...
	@RequestMapping(value="board/{board_no}/{reply_no}", method=RequestMethod.DELETE)
