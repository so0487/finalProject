...
public class ExamVO {
	private int exam_point;  //배점
	private String exam_answer;  //정답
	private String exam_title;  //문제제목
	private String exam_category_no;  //문제카테고리번호
	private String exam_status;  //삭제여부
	private String test_no;  //시험번호
	private String exam_no;  //시험문제번호pk
	private int exam_number; //시험문제번호
	...
	public int getExam_point() {
		return exam_point;
	}
	public void setExam_point(int exam_point) {
		this.exam_point = exam_point;
	}
	...
	public String toString() {
		return "ExamVO [exam_point=" + exam_point + ", exam_answer=" + exam_answer + ", exam_title=" + exam_title
				+ ", exam_category_no=" + exam_category_no + ", exam_status=" + exam_status + ", test_no=" + test_no
				+ ", exam_no=" + exam_no + ", exam_number=" + exam_number + "]";
	}
