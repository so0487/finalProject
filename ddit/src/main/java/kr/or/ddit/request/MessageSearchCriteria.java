...
public class MessageSearchCriteria {
	...
	public MessageSearchCriteria(int page, int perPageNum, String searchType, String keyword, String board_no) {
		super();
		this.page = page;
	...
	public MessageSearchCriteria(String page, String perPageNum, String searchType, String keyword) {
		super();
