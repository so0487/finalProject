...
public class ZoomDetails extends DefaultApi20{
   ...
   private final static String CLIENT_ID = "Lf3OKyWQdmhEEKpsZBgsg";
    ...
    private final static String REDIRECT_URI = "https://192.168.31.54/ddit";
    private final static String REDIRECT_URI_CREATE_INTERVIEW = "https://192.168.31.54/ddit/interview/create/meetings/redirect";
    private final static String REDIRECT_URI_CREATE_LECTURE = "https://192.168.31.54/ddit/lecture/create/meetings/redirect";
    private final static String REDIRECT_URI_CREATE_COUNSEL = "https://192.168.31.54/ddit/counsel/create/meetings/redirect";
   ...
   public static String getRedirectUriCreate_interview() {
      return REDIRECT_URI_CREATE_INTERVIEW;
   }
   
   public static String getRedirectUriCreate_lecutre() {
	      return REDIRECT_URI_CREATE_LECTURE;
   }
   
   public static String getRedirectUriCreate_counsel() {
	      return REDIRECT_URI_CREATE_COUNSEL;
   }
