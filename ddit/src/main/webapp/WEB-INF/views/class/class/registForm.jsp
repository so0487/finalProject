	...
	<div class="content-body">
		...
		<div class="col-lg-5 mb-20">
			...
			<div class="col-lg-3 mb-20">
				<button type="button"  style="border:1px solid #dddddd" class="btn btn-outline" id="registBtn">
					<span>다음</span>
				</button>
				<button type="button"  style="border:1px solid #dddddd" class="btn btn-outline" id="cancelBtn">
					<span>취소</span>
				</button>
			</div>
		</div>
...
$('#class_recruitment_end').on('change',function(){
	...
	if($('input[name="class_recruitment_start"]').val()!="" && $('input[name="class_recruitment_start"]').val()>$('#class_recruitment_end').val() ){
		alert("모집 시작날짜를 다시 입력해주세요.");
		var str4 = $('input[name="class_recruitment_end"]').val();
		document.getElementById("class_recruitment_start").value="";
		document.getElementById("class_recruitment_start").max = str4;
		$('select[name="subject_no"]').attr('disabled','disabled');
		$('select[name="professor_id"]').attr('disabled','disabled');
		$('input[name="lecture_name"]').attr('disabled','disabled');
		$('input[name="evalution"]').attr('disabled','disabled');
...
$('#registBtn').on('click',function(e){
	...
	if($('input[name="class_start_date"]').val()==""||$('input[name="class_start_date"]').val()==""||$('input[name="class_max"]').val()==""|| $('select[name="subject_no"]').eq(0).val()==""|| $('select[name="subject_no"]').eq(1).val()==""
		|| $('select[name="professor_id"]').eq(0).val()==""|| $('select[name="professor_id"]').eq(1).val()==""||$('input[name="evalution"]').eq(0).val()==""||$('input[name="evalution"]').eq(1).val()==""||$('input[name="evalution"]').eq(2).val()==""||$('input[name="evalution"]').eq(3).val()==""||$('input[name="evalution"]').eq(4).val()==""||$('input[name="evalution"]').eq(5).val()==""||$('input[name="evalution"]').eq(0).val()==""
		|| $('input[name="lecture_name"]').val()=="" ){
