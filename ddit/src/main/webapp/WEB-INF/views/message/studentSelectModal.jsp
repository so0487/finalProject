						...
						<div class="form-group">
							<table class="table footable">
								...
								<c:forEach items="${studentList}" var="studentList"	varStatus="status">
									<c:if test="${studentList.member_role eq 'STUDENT'}">
										<tbody>
											<tr>
												<th><input type="checkbox" name="member" id="member" class="member" value="${studentList.member_id}"></th>
												<td>${studentList.member_id}</td>
												<td>${studentList.member_name}</td>
												<td>${studentList.member_role}</td>
											</tr>
										</tbody>
									</c:if>
								</c:forEach>
							...
							<div class="card-footer">
								<%@include file="/WEB-INF/views/pagination/messageStudent_pagination.jsp" %>
							</div>
						</div>
					</div>
				</div>
